...
| **[`plots/`](plots/)** | Output directory for any figures generated by the production scripts (gitkeep'd; populate locally as needed). |

## Reproduction

```bash
pip install numpy scipy
cd experiments/lattice_1d
